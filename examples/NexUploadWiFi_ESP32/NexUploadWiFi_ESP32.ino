/**
 * @file NexUploadWiFi_ESP32.ino
 *
 * The implementation of uploading firmware to Nextion HMI displays over WiFi. 
 *
 * @author  Bogdan Symchych (email:<bogdan.symchych@gmail.com>)
 * @date    2019/10/1
 *
 * @copyright 
 * Copyright (C) 2019
